...
import { objectArraysingle, optionCustom, optionTooltips, optiondefault, optionselectyear } from "../../../common/selectdata";
...
const FormValidation = () =>{
  ...
  return (
    <Fragment>
     <Pageheader title="FORM VALIDATIONS"  heading="Forms"   active="Form Validations" />
      <div className="row">
        <Col lg={12} md={12}>
          <Card>
            <Card.Header>
