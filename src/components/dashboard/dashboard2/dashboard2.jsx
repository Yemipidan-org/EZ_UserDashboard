...
import { COLUMNS2, DATATABLE2, GlobalFilter } from "../../../common/tablesfunctionaldata";
import { Budget, Statistics2, Viewers1 } from "../../../common/chartdata";
const Dashboard2 = () =>{ 
          ...
          <Card className=" px-3 ps-4">
            <Row className="index1">
              <Col xl={6}
                ...
                xxl={3}
              >
                <Row className=" border-end bd-xs-e-0 p-sm-3">
              ...
              <Col xl={6}
                ...
                xxl={3}
   >
                <Row className=" border-end bd-md-e-0 bd-xs-e-0 bd-lg-e-0 bd-xl-e-0  p-sm-3">
                  <div className="col-3 d-flex align-items-center justify-content-center">
              ...
              <Card className="custom-card overflow-hidden">
                ...
                <Card.Body>
                  <Row className=" mb-2 ps-lg-5">
                    ...
                    <div id="statistics2"><Statistics2/></div>
                </Card.Body>
              </Card>
            </Col>
