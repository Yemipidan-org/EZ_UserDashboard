...
const Accordions = () => {
  return (
    <Fragment>
      <Pageheader title="ACCORDION" heading="Advanced UI" active="Accordion" />
            ...
            <Card.Body>
              <div className="panel-group1" id="accordion11" role="tablist">
                <div className="card overflow-hidden mb-0">
                  <Accordion>
                    <Accordion.Item eventKey="Item1" className="accordion-toggle panel-heading1 pb-0">
        ...
        <Col xl={12}>
          <Card>
            ...
            <Card.Body className=" h-100">
              <div id="accordion01" className="w-100 overflow-hidden Accordion-Style02 ">
                <div className="mb-2">
                  <Accordion defaultActiveKey="0" flush className="accor" id="headingOne1">
                    <Accordion.Item eventKey="0">
                      <Accordion.Header> Accordions With Text</Accordion.Header>
                      <Accordion.Body id="collapseOne1" className="border p-3 accstyle border-top-0">
                        <div>
                    ...
                    <Accordion.Item eventKey="1">
                      ...
                      <Accordion.Body className="border p-3 accstyle border-top-0">
                        <div >
                          <Row>
                            <Col lg={3} md={6}>
                              <Link to={`${import.meta.env.BASE_URL}pages/gallery/`} className="bg-transparent">
                                <img className="img-fluid rounded m-2 " src={imagesData('photo11')} alt="banner" />
                              </Link>
                            </Col>
                            <Col lg={3} md={6}>
                              <Link to={`${import.meta.env.BASE_URL}pages/gallery/`} className="bg-transparent">
                                <img className="img-fluid rounded m-2" src={imagesData('photo10')} alt="banner" />
                              </Link>
                            </Col>
                            <Col lg={3} md={6}>
                              <Link to={`${import.meta.env.BASE_URL}pages/gallery/`} className="bg-transparent">
                            ...
                            <Col lg={3} md={6}>
                              <Link to={`${import.meta.env.BASE_URL}pages/gallery/`} className="bg-transparent">
                                <img className="img-fluid rounded m-2" src={imagesData('photo12')} alt="banner" />
                              </Link>
                            </Col>
                          </Row>
                        </div>
        ...
        <Col lg={12} md={12}>
          <Card>
            <Card.Body>
              ...
              <div aria-multiselectable="true" className="accordion accordion-dark" id="accordion2" role="tablist"
              >
                <div className="card mb-0">
                  <Accordion defaultActiveKey="0" flush>
                    <Accordion.Item eventKey="0">
                      <Accordion.Header className="" id="headingOne2" role="tab">
                    ...
                    <Accordion.Item eventKey="1" className="card mb-0 mt-2">
                      <Accordion.Header className="" id="headingTwo4" role="tab">
                    ...
                    <Accordion.Item eventKey="2" className="card mb-0 mt-2">
                      <Accordion.Header className="" id="headingThree2" role="tab">
