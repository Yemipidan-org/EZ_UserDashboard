    ...
    <Row>
      <Col xxl={6}xl={12}lg={12}md={12}>
        <Card className="card overflow-hidden">
          <Link
            to={`${import.meta.env.BASE_URL}advancedui/blogdetails/`}
    ...
    <div className="row ">
      <Col xxl={3}xl={6}lg={6}sm={6}>
        <Card className="card custom-card card-img-top-1">
          ...
          <div className="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top flex-wrap">
            <div className="main-img-user online">
              <Link to={`${import.meta.env.BASE_URL}pages/profile/`}>
                <img
                  alt="avatar"
      ...
      <Col xxl={3}xl={6}lg={6}sm={6}>
        <Card className="card custom-card card-img-top-1">
          <Link to={`${import.meta.env.BASE_URL}advancedui/blogdetails/`}>
            <img className="card-img-top w-100 w-100" src={imagesData('photo1')} alt="" />
          </Link>
          <Card.Body className="pb-0">
            <Link to={`${import.meta.env.BASE_URL}advancedui/blogdetails/`}>
              <h4 className="card-title">
          ...
          <div className="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top flex-wrap">
            <div className="main-img-user online">
              <Link to={`${import.meta.env.BASE_URL}pages/profile/`}>
                <img  alt="avatar" src={imagesData('female9')}
                />
              </Link>
            </div>
            <div className="main-contact-body">
      ...
      <Col xxl={3}xl={6}lg={6}sm={6}>
        <Card className="card custom-card card-img-top-1">
          <Link to={`${import.meta.env.BASE_URL}advancedui/blogdetails/`}>
            <img  className="card-img-top w-100 w-100" src={imagesData('photo9')}  alt="" />
          </Link>
          <Card.Body className="pb-0">
            <Link to={`${import.meta.env.BASE_URL}advancedui/blogdetails/`}>
              <h4 className="card-title">
          ...
          <div className="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top flex-wrap">
            <div className="main-img-user online">
              <Link to={`${import.meta.env.BASE_URL}pages/profile/`}>
                <img alt="avatar"  src={imagesData('female7')} />
              </Link>
            </div>
            <div className="main-contact-body">
              <Link to={`${import.meta.env.BASE_URL}pages/profile/`}>
