...
const MaterialIcons = () => {
  ...
  <div className="main-container container-fluid">
    ...
    <Pageheader title="MATERIAL ICONS"  heading="Icons"   active="Material Icons" />
    <Row>
      <Col md={12}>
        <Card className="custom-card">
          <Card.Header className=" mb-0 mt-2 ms-1 border-bottom-0">
            <h6 className="main-content-label mb-0">Material design icons</h6>
        ...
        <Card className="custom-card">
          <Card.Header className=" mb-0 mt-2 ms-1 border-bottom-0">
            <h6 className="main-content-label mb-0">Material Outlined Icons</h6>
            <p className="mb-0 mt-3">
              Simply beautiful open source icons.
            </p>
          </Card.Header>
        ...
        <Card className="custom-card">
          <Card.Header className=" mb-0 mt-2 ms-1 border-bottom-0">
            <h6 className="main-content-label mb-0">Material Two Toned Icons</h6>
            <p className="mb-0 mt-3">
              Simply beautiful open source icons.
            </p>
          </Card.Header>
