                    ...
                    <Col xxl={6} lg={12} md={12}>
                      <Row >
                            ...
                            <div id="thumbcarousel" className="carousel slide">
                              <div className="carousel-inner">
                                ...
                                >
                                  <SwiperSlide className="thumb my-2 me-1">
                                    <img alt=""
                                      src={imagesData('shirt1')}
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide className="thumb my-2 me-1">
                                    <img alt=""
                                      src={imagesData('shirt2')}
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide className="thumb my-2 me-1">
                                    <img alt=""
                                      src={imagesData('shirt3')}
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide className="thumb my-2 me-1">
                                    <img alt=""
                                      src={imagesData('shirt4')}
                                    />
                                  </SwiperSlide>
                                </Swiper>
                              </div>
                        ...
                        <Col xxl={10} xl={10} lg={10} md={10} sm={10}>
                         ...
                         <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/cart/`} className="btn ripple btn-primary me-2"><i className="fe fe-shopping-cart"> </i> Add to cart</Link> 
                         <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/checkout/`} className="btn ripple btn-secondary"><i className="fe fe-credit-card"> </i> Buy Now</Link> 
                         </div>
                        </Col>
                      </Row>
                    </Col>
