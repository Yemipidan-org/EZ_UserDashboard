                      ...
                      <div className="">
                        <div className="main-signup-header">
                                    ...
                                    >
                                      <Form action="#" >
                                        ...
                                        <Button
                                          ...
                                          href={`${import.meta.env.BASE_URL}dashboard/dashboard1/`}
                          ...
                          <div className="main-signin-footer text-center mt-3">
                            <p>
                              <Link to={`${import.meta.env.BASE_URL}pages/authentication/forgotpassword/`} className="mb-3">
                                Forgot password?
                              </Link>
                            </p>
                            <p>
                              Don't have an account?{" "}
                              <Link to={`${import.meta.env.BASE_URL}pages/Authentication/sigup/`}>Create an Account</Link>
                            </p>
                          </div>
                        </div>
                      </div>
