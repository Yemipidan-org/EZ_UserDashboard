...
import { Basicdata, Business, Monthdata } from '../../../common/commondata';
...
const Pricing = () =>{
  ...
  <Fragment>
    ...
    {Basicdata.map((playerData) => (
          <Col sm={12} xxl={3} md={6} lg={6} key={Math.random()}>
          ...
          >
            ...
            <Card.Body className="pt-2 pb-0">
              <ul className="text-justify pricing-body text-muted ps-0 mb-4">
                ...
                <li className="mb-1">
                  <label className="d-flex align-items-center p-2 br-5 border flex-wrap">
                    <span className="check-box mb-0">
                      <span className="ckbox">
                        <input
                          defaultChecked
        ...
        <Tab.Pane eventKey="Year">
          <Fragment>
            <div className="tab-pane">
              <Row className="d-flex align-items-center justify-content-center">
                {Monthdata.map((playerData) => (
                  <Col key={Math.random()} sm={12} xxl={3} md={6} lg={6}>
                    <Card className="p-3 border-primary pricing-card">
                      <Card.Header className="text-justified pt-2">
                        <p className="tx-18 font-weight-semibold mb-1 pe-0 text-start">
                          {playerData.type}
                          <span className=" tx-11 float-end badge bg-primary text-white px-2 py-1 rounded-pill mt-2">
                            {playerData.most}
                          </span>
