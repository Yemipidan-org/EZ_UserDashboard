          ...
          <Card.Body>
            <Row>
              <div className="col">
                ...
                <div className="h3 mt-2 mb-2 d-inline-flex alin-items-center">
                  <b>19.89K</b>
                  <span className="text-success tx-13 ms-2 mt-auto mb-1">(+25%)</span>
                </div>
              </div>
          ...
          <Card.Body>
            <Row>
              <div className="col">
                ...
                <div className="h3 mt-2 mb-2 d-inline-flex align-items-center">
                  <b>286</b>
                  <span className="text-success tx-13 ms-2 mt-auto mb-1">(+08%)</span>
                </div>
              </div>
              <div className="col-auto align-self-center ">
                <div className="feature mt-0 mb-0">
          ...
          <Card.Body>
            <Row>
              <div className="col">
                ...
                <div className="h3 mt-2 mb-2 d-inline-flex align-items-center">
                  <b>$2.98M</b>
                  <span className="text-success tx-13 ms-2 mt-auto mb-1">(+35%)</span>
                </div>
              </div>
              <div className="col-auto align-self-center ">
                <div className="feature mt-0 mb-0">
        ...
        <Card className=" card-img-holder">
          <Card.Body className="list-icons">
            ...
            <Card.Footer className="p-0">
              <p className="text-muted mb-0 pt-4 d-inline-flex align-items-center">
                <i
      ...
      <Col sm={12} lg={6} xl={3}>
        <Card className=" card-img-holder">
          <Card.Body className="list-icons">
            ...
            <Card.Footer className="p-0">
              <p className="text-muted mb-0 pt-4 d-inline-flex align-items-center">
                <i className="si si-check text-primary me-2"></i> Recent History
              </p>
            </Card.Footer>
          </Card.Body>
        </Card>
      </Col>
      <Col sm={12} xxl={4} lg={12}>
            ...
            <table className="table table-borderless mt-3  border-0 rating-table">
              <tbody>
                <tr>
                  ...
                  <td className="w-100">
                    <div className="progress mt-2 ht-5  progress-overall-rating">
                      <div
                        aria-valuemax="100"
                        aria-valuemin="0"
                        aria-valuenow="80"
