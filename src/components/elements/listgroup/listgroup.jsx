...
const ListGroups = () => {
  ...
  return (
    <Fragment>
      <Pageheader title="LIST GROUP"  heading="Elements"   active="List Group" /> 
    ...
    And a fifth one
        ...
        <Col xl={6}>
          <Card>
            <Card.Header>
              <div className="d-flex">
                <h3 className="card-title pe-3">Basic List group with Active item</h3>
                <Form className="ms-auto">
                  <Form.Check
                    label="Show Code"
                     type="switch"
        ...
        <Col xl={6}>
          <Card>
            <Card.Body className="">
              ...
              <h3 className="card-title  mg-b-10 pe-3">List group with Checkboxes</h3>
              <Form className="ms-auto">
                <Form.Check
                  label="Show Code"
                   type="switch"
