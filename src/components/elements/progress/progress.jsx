...
import {  ProgressBar, Card, Col, Row, Form, Collapse } from "react-bootstrap";
...
const Progressbar = () => {
  ...
  return (
    <Fragment>
     <Pageheader title="PROGRESS"  heading="Elements"   active="Progress" />
              ...
              <div className="text-wrap">
                <div className="example">
                  ...
                  <div className="progress progress-style ht-5 mb-4 ">
                    <ProgressBar
                      className="progress-bar bg-primary wd-80p progressbar-styles "
                      role="progressbar"
                      variant="primary"
                    ></ProgressBar>
                  </div>
                  <div className="progress progress-style ht-5 mb-4">
                    <ProgressBar
                      variant="danger"
                      className="progress-bar bg-danger wd-70p progressbar-styles"
                      role="progressbar"
                    ></ProgressBar>
                  </div>
                  <div className="progress progress-style ht-5 mb-4">
                    <ProgressBar
                      variant="success" 
                      className="progress-bar bg-success wd-60p progressbar-styles"
                      role="progressbar"
                    ></ProgressBar>
                  </div>
                  <div className="progress progress-style ht-5 mb-4">
                    <ProgressBar
                      variant="warning"
                      className="progress-bar bg-warning wd-50p progressbar-styles"
                      role="progressbar"
                    ></ProgressBar>
                  </div>
                  <div className="progress progress-style ht-5 mb-0">
                    <ProgressBar
                      variant="info"
                      className="progress-bar bg-info wd-40p progressbar-styles"
                      role="progressbar"
                    ></ProgressBar>
                  </div>
