...
import { OverlayTrigger, Tooltip , Button, Form, Modal,  Table, ButtonGroup, Col, InputGroup, Card, Row, } from "react-bootstrap";
...
export const DATATABLE5 = [
  {
    SNO: <Form.Check className='align-middle users-list' />,
